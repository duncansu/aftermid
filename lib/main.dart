...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final animationWrapper = _AnimationWrapper(
        GlobalKey<_AnimationWrapperState>(), Alignment.bottomLeft);
    ...
    var btn = RaisedButton.icon(
      ...
      label: Padding(
        ...
        child: Text('開跑', style: TextStyle(fontSize: 18, color: Colors.white),),
      ),
      color: Colors.lightBlue,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
      onPressed: () {
        animationWrapper.setAlignment(Alignment.bottomRight);
      },
    );
  ...
  Widget build(BuildContext context) {
    var w = Expanded(
      child: AnimatedContainer(
        ...
        child: Icon(Icons.airport_shuttle_rounded, color: Colors.lightBlue, size: 50),
